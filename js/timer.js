...
let TIME_LIMIT = 180; // Default time limit
let timePassed = 0;
...
function playAlarm() {
  const audio = new Audio("https://zavistar.com/alarm-clock.mp3"); // Replace 'path/to/alarm-sound.mp3' with the actual path to your alarm sound file
  audio.play();
}
